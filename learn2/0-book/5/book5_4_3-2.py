...
def getHeatMap(x):
	...
	african_elephant_output = model.output[:, 0]	# 模型输出的，对应预测的类别输出公式
	
	last_conv_layer = model.get_layer('conv2d_4') # 最后一个卷积层
